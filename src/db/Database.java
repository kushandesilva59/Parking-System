...
public class Database {
    ...
    public static Slot [] slotVans = {new Slot(1,true),new Slot(2,true),new Slot(3,true),new Slot(4,true),new Slot(12,true),new Slot(13,true)};
    public static Slot [] slotLorry = {new Slot(5,true),new Slot(6,true),new Slot(7,true),new Slot(8,true),new Slot(9,true),new Slot(10,true),new Slot(11,true)};
    public static ArrayList <parkedVehicle> parkedVehicles = new ArrayList<>();
    public static ArrayList <OnDeliveryVehicle> onDeliveryVehicles = new ArrayList<>();
